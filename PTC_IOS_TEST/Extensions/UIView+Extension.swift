...
extension UIView {
    ...
    @discardableResult
    public func anchorSize(width: NSLayoutDimension? = nil, widthConstant: CGFloat = 0,
                           height: NSLayoutDimension? = nil, heightConstant: CGFloat = 0) -> UIView {
    ...
    @discardableResult
    public func anchorSizeWithMultiplier(width: NSLayoutDimension? = nil, widthMultiplier: CGFloat = 1,
                           height: NSLayoutDimension? = nil, heightMultiplier: CGFloat = 1) -> UIView {
    ...
    @discardableResult
    public func fillSuperview(top: CGFloat = 0, bottom: CGFloat = 0,
                              left: CGFloat = 0, right: CGFloat = 0) -> UIView {
